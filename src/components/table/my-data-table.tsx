            ...
            <TableBody>
              {currentItems.map((row, rowIndex) => (
                <React.Fragment key={rowIndex}>
                  <TableRow
                    onClick={() =>
                      router.push(`/dashboard/lead/${row.original.resident_id}`)
                    }
                    className="cursor-pointer bg-white hover:bg-gray-50 data-[state=selected]:bg-white text-[#535862] text-sm font-normal leading-4"
