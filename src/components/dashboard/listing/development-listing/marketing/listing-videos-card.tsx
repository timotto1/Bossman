...
export default function ListingVideosCard() {
  ...
  useEffect(() => {
    if (!isLoading && developmentListing) {
      form.reset({
        youtubeURL: developmentListing?.youtube_url,
        vimeoURL: developmentListing?.vimeo_url,
        virtualTourSupplier: developmentListing?.virtual_tour_supplier,
        virtualTourURL: developmentListing?.virtual_tour_url,
      });
    }
